...
const CompanyCreate = () => {
    ...
    const createNewCompany = async () => {
        try {
            const res = await axios.post("https://career-connect-79k9.onrender.com/api/v1/company/register", { companyName }, {
                headers: {
    ...
    return (
        <div>
            <Navbar />
            <div className='max-w-4xl mx-auto bg-slate-100 p-5 py-2 my-5 shadow-2xl'>
                <div className='my-10'>
