...
const CreateJobs = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`https://career-connect-79k9.onrender.com/api/v1/job/postjob`, input, {
                headers: {
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center w-screen my-5'>
                <div className='p-8 max-w-4xl border border-gray-200 shadow-2xl rounded-md bg-slate-100'>
