...
const CompanySetup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            const res = await axios.put(`https://career-connect-79k9.onrender.com/api/v1/company/update/${params.id}`, formData, {
                headers: {
    ...
    return (
        <div>
            <Navbar />
            <div className='max-w-xl mx-auto my-10 bg-slate-100 shadow-2xl'>
